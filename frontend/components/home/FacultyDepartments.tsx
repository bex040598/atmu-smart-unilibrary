...
const FACULTIES = [
  ...
  },
  {
    ...
    depts: [
      { slug: "filologiya", name: { uz: "Filologiya", ru: "Филология", en: "Philology", tr: "Filoloji" }, resources: 156, subjects: 8, desc: { uz: "O'zbek va xorijiy tillar, adabiyot va tilshunoslik", ru: "Узбекский и иностранные языки, литература и языкознание", en: "Uzbek and foreign languages, literature and linguistics", tr: "Özbek ve yabancı diller, edebiyat ve dilbilim" }, color: "#cc6600" },
      { slug: "tarix", name: { uz: "Tarix", ru: "История", en: "History", tr: "Tarih" }, resources: 124, subjects: 8, desc: { uz: "O'zbekiston tarixi, jahon tarixi va tarixiy tadqiqotlar", ru: "История Узбекистана, всемирная история и исторические исследования", en: "History of Uzbekistan, world history and historical research", tr: "Özbekistan tarihi, dünya tarihi ve tarihsel araştırmalar" }, color: "#996622" },
      { slug: "pedagogika", name: { uz: "Pedagogika", ru: "Педагогика", en: "Pedagogy", tr: "Pedagoji" }, resources: 178, subjects: 10, desc: { uz: "Ta'lim metodikasi, psixologiya va raqamli pedagogika", ru: "Методика образования, психология и цифровая педагогика", en: "Educational methodology, psychology and digital pedagogy", tr: "Eğitim metodolojisi, psikoloji ve dijital pedagoji" }, color: "#cc2255" },
    ],
  },
];
